...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1615: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1615(f,arguments.length,x0,x1,x2) }),
      _1616: (x0,x1) => x0.append(x1),
      _1617: (x0,x1) => x0.append(x1),
      _1622: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1623: (x0,x1) => x0.removeAttribute(x1),
      _1624: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1626: (x0,x1) => x0.getResponseHeader(x1),
      _1649: (x0,x1) => x0.item(x1),
      _1651: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1652: (x0,x1) => x0.removeAttribute(x1),
      _1653: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1655: x0 => x0.remove(),
      _1656: (x0,x1) => x0.csp = x1,
      _1657: x0 => x0.csp,
      _1658: (x0,x1) => x0.getCookieExpirationDate(x1),
      _1659: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1660: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1661: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1661(f,arguments.length,x0) }),
      _1662: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1663: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1663(f,arguments.length,x0) }),
      _1664: x0 => x0.send(),
      _1665: () => new XMLHttpRequest(),
      _1666: x0 => x0.decode(),
      _1667: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1668: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1669: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1669(f,arguments.length,x0) }),
      _1670: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1671: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1671(f,arguments.length,x0) }),
      _1672: x0 => x0.send(),
      _1673: () => new XMLHttpRequest(),
      ...
      _1711: (x0,x1) => x0.getItem(x1),
      _1712: (x0,x1) => x0.removeItem(x1),
      _1713: (x0,x1,x2) => x0.setItem(x1,x2),
      _1809: x0 => new Array(x0),
      _1811: x0 => x0.length,
      _1813: (x0,x1) => x0[x1],
      _1814: (x0,x1,x2) => x0[x1] = x2,
      _1815: x0 => new Promise(x0),
      _1817: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1819: x0 => new Int8Array(x0),
      _1820: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1821: x0 => new Uint8Array(x0),
      _1827: x0 => new Uint16Array(x0),
      _1829: x0 => new Int32Array(x0),
      _1831: x0 => new Uint32Array(x0),
      _1833: x0 => new Float32Array(x0),
      _1835: x0 => new Float64Array(x0),
      _1837: (o, c) => o instanceof c,
      _1840: (o,s,v) => o[s] = v,
      ...
      _1866: () => Symbol("jsBoxedDartObjectProperty"),
      _1867: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1868: () => new TextDecoder("utf-8", {fatal: true}),
      _1869: () => new TextDecoder("utf-8", {fatal: false}),
      _1870: x0 => new WeakRef(x0),
      _1871: x0 => x0.deref(),
      _1877: Date.now,
      _1879: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1880: s => {
      ...
      _1882: () => typeof dartUseDateNowForTicks !== "undefined",
      _1883: () => 1000 * performance.now(),
      _1884: () => Date.now(),
      _1885: () => {
      ...
      _1887: () => new WeakMap(),
      _1888: (map, o) => map.get(o),
      _1889: (map, o, v) => map.set(o, v),
      _1890: () => globalThis.WeakRef,
      _1901: s => JSON.stringify(s),
      _1902: s => printToConsole(s),
      _1903: a => a.join(''),
      _1904: (o, a, b) => o.replace(a, b),
      _1906: (s, t) => s.split(t),
      _1907: s => s.toLowerCase(),
      _1908: s => s.toUpperCase(),
      _1909: s => s.trim(),
      _1910: s => s.trimLeft(),
      _1911: s => s.trimRight(),
      _1912: (s, n) => s.repeat(n),
      _1913: (s, p, i) => s.indexOf(p, i),
      _1914: (s, p, i) => s.lastIndexOf(p, i),
      _1915: (s) => s.replace(/\$/g, "$$$$"),
      _1916: Object.is,
      _1917: s => s.toUpperCase(),
      _1918: s => s.toLowerCase(),
      _1919: (a, i) => a.push(i),
      _1920: (a, i) => a.splice(i, 1)[0],
      _1922: (a, l) => a.length = l,
      _1923: a => a.pop(),
      _1924: (a, i) => a.splice(i, 1),
      _1926: (a, s) => a.join(s),
      _1927: (a, s, e) => a.slice(s, e),
      _1929: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1930: a => a.length,
      _1931: (a, l) => a.length = l,
      _1932: (a, i) => a[i],
      _1933: (a, i, v) => a[i] = v,
      ...
      _1936: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1937: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1938: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1939: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1940: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1941: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      ...
      _1945: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1946: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1947: (t, s) => t.set(s),
      _1949: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1951: o => o.buffer,
      _1952: o => o.byteOffset,
      _1953: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1954: (b, o) => new DataView(b, o),
      _1955: (b, o, l) => new DataView(b, o, l),
      _1956: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1957: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1958: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1959: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1960: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1961: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1962: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1963: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1964: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1965: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1966: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1967: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1970: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1971: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1972: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1973: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1974: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1975: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1977: () => globalThis.performance,
      _1978: () => globalThis.JSON,
      _1979: x0 => x0.measure,
      _1980: x0 => x0.mark,
      _1981: x0 => x0.clearMeasures,
      _1982: x0 => x0.clearMarks,
      _1983: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
      _1984: (x0,x1,x2) => x0.mark(x1,x2),
      _1985: x0 => x0.clearMeasures(),
      _1986: x0 => x0.clearMarks(),
      _1987: (x0,x1) => x0.parse(x1),
      _1988: () => new XMLHttpRequest(),
      _1989: (x0,x1,x2) => x0.open(x1,x2),
      _1990: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1991: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1992: x0 => x0.abort(),
      _1993: x0 => x0.abort(),
      _1994: x0 => x0.abort(),
      _1995: x0 => x0.abort(),
      _1996: (x0,x1) => x0.send(x1),
      _1998: x0 => x0.getAllResponseHeaders(),
      _1999: (o, t) => o instanceof t,
      ...
      _2015: x0 => x0.abort(),
      _2016: () => new AbortController(),
      _2017: x0 => x0.getReader(),
      _2018: x0 => x0.read(),
      _2019: x0 => x0.cancel(),
      _2021: () => new XMLHttpRequest(),
      _2023: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _2068: () => globalThis.window.flutter_inappwebview,
      _2074: (x0,x1) => x0.nativeCommunication = x1,
      _2075: (x0,x1) => x0.key(x1),
      _2094: (s, m) => {
        try {
      ...
      _2099: x0 => x0.pop(),
      _2101: o => o === undefined,
      _2120: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _2122: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _2123: o => o instanceof RegExp,
      _2124: (l, r) => l === r,
      _2125: o => o,
      _2126: o => o,
      _2127: o => o,
      ...
      _2129: o => o.length,
      _2132: (o, i) => o[i],
      _2133: f => f.dartFunction,
      _2134: l => arrayFromDartList(Int8Array, l),
      _2135: l => arrayFromDartList(Uint8Array, l),
      _2136: l => arrayFromDartList(Uint8ClampedArray, l),
      _2137: l => arrayFromDartList(Int16Array, l),
      _2138: l => arrayFromDartList(Uint16Array, l),
      _2139: l => arrayFromDartList(Int32Array, l),
      _2140: l => arrayFromDartList(Uint32Array, l),
      _2141: l => arrayFromDartList(Float32Array, l),
      _2142: l => arrayFromDartList(Float64Array, l),
      _2143: x0 => new ArrayBuffer(x0),
      _2144: (data, length) => {
      ...
      _2145: l => arrayFromDartList(Array, l),
      _2146: () => ({}),
      _2147: () => [],
      _2148: l => new Array(l),
      _2149: () => globalThis,
      ...
      _2177: x0 => x0.flags,
      _2178: x0 => x0.multiline,
      _2179: x0 => x0.ignoreCase,
      _2180: x0 => x0.unicode,
      _2181: x0 => x0.dotAll,
      _2182: (x0,x1) => x0.lastIndex = x1,
      _2184: (o, p) => o[p],
      _2185: (o, p, v) => o[p] = v,
      _2187: x0 => x0.random(),
      _2188: x0 => x0.random(),
      ...
      _2242: x0 => x0.src,
      _2243: (x0,x1) => x0.src = x1,
      _2244: x0 => x0.naturalWidth,
      _2245: x0 => x0.naturalHeight,
      _2270: x0 => x0.status,
      _2271: (x0,x1) => x0.responseType = x1,
      _2273: x0 => x0.response,
      _2277: () => globalThis.window.flutterCanvasKit,
      _2278: () => globalThis.window._flutter_skwasmInstance,
      _2326: x0 => x0.readyState,
      _2328: (x0,x1) => x0.timeout = x1,
      _2330: (x0,x1) => x0.withCredentials = x1,
      _2331: x0 => x0.upload,
      _2332: x0 => x0.responseURL,
      _2333: x0 => x0.status,
      _2334: x0 => x0.statusText,
      _2336: (x0,x1) => x0.responseType = x1,
      _2337: x0 => x0.response,
      _2338: x0 => x0.responseText,
      _2351: x0 => x0.loaded,
      _2352: x0 => x0.total,
      _2417: x0 => x0.style,
      _2894: x0 => x0.src,
      ...
      _2898: x0 => x0.name,
      _2899: (x0,x1) => x0.name = x1,
      _2900: x0 => x0.sandbox,
      _2901: x0 => x0.allow,
      _2902: (x0,x1) => x0.allow = x1,
      _2903: x0 => x0.allowFullscreen,
      _2904: (x0,x1) => x0.allowFullscreen = x1,
      _2909: x0 => x0.referrerPolicy,
      _2910: (x0,x1) => x0.referrerPolicy = x1,
      _4149: () => globalThis.window,
      _4191: x0 => x0.document,
      _4213: x0 => x0.navigator,
      _4477: x0 => x0.localStorage,
      _4604: x0 => x0.userAgent,
      _4608: x0 => x0.language,
      _4609: x0 => x0.languages,
      _4824: x0 => x0.length,
      _6851: x0 => x0.signal,
      _6913: x0 => x0.baseURI,
      ...
      _7023: x0 => x0.body,
      _7373: x0 => x0.id,
      _7374: (x0,x1) => x0.id = x1,
      _7618: x0 => x0.length,
      _8755: x0 => x0.value,
      _8757: x0 => x0.done,
      _9480: x0 => x0.url,
      _9482: x0 => x0.status,
      _9484: x0 => x0.statusText,
      _9485: x0 => x0.headers,
      _9486: x0 => x0.body,
      _11642: (x0,x1) => x0.border = x1,
      _11920: (x0,x1) => x0.display = x1,
      _12084: (x0,x1) => x0.height = x1,
      _12774: (x0,x1) => x0.width = x1,
